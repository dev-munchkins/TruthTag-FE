...
const Footer = ({ clicked, padding }: FooterType) => {
  const router = useRouter();
  return (
    <SFooter padding={padding}>
      <svg
        width="24"
        height="24"
        viewBox="0 0 24 24"
...
const SFooter = styled.div<{ padding: boolean | undefined }>`
  height: 56px;
  flex-shrink: 0;
  ...
  padding: ${(props) => (props.padding ? "0px 35px" : "0px 10px")};
